...
<div class="note">
    <?php echo JText::_( "J2STORE_SAGEPAY3_PAYMENT_STANDARD_FORM_MESSAGE" ); ?>
</div>

<table id="sagepay_form" class="table">            
    <tr>
        <td class="field_name"><?php echo JText::_( 'J2STORE_SAGEPAY3_CREDITCARD_TYPE' ) ?></td>
        <td><?php echo $vars->cctype_input ?></td>
    </tr>
    <tr>
        <td class="field_name"><?php echo JText::_( 'J2STORE_SAGEPAY3_CREDITCARD_HOLDERNAME' ) ?></td>
        ...
        title="<?php echo JText::_('J2STORE_SAGEPAY3_VALIDATION_ENTER_CARDHOLDER_NAME'); ?>"
        />
         <div class="j2error"></div>
        </td>
    </tr>
    <tr>
        <td class="field_name"><?php echo JText::_( 'J2STORE_SAGEPAY3_CARD_NUMBER' ) ?></td>
        <td><input type="text" class="required number"
        name="cardnum"
        size="35"
        value="<?php echo !empty($vars->prepop['x_card_num']) ? ($vars->prepop['x_card_num']) : '' ?>" 
        title="<?php echo JText::_('J2STORE_SAGEPAY3_VALIDATION_ENTER_CREDITCARD'); ?>"
        />
         <div class="j2error"></div>
        </td>
    </tr>
    <tr>
        <td class="field_name"><?php echo JText::_( 'J2STORE_SAGEPAY3_EXPIRATION_DATE' ) ?>(MMYY)</td>
        <td>
        <select name="month" class="required number"
         title="<?php echo JText::_('J2STORE_SAGEPAY3_VALIDATION_ENTER_EXPIRY_MONTH'); ?>"
        >
        ...
        title="<?php echo JText::_('J2STORE_SAGEPAY3_VALIDATION_ENTER_EXPIRY_YEAR'); ?>"
        >
    ...
    <tr>
        <td class="field_name"><?php echo JText::_( 'J2STORE_SAGEPAY3_CARD_CVV' ) ?></td>
        <td>
        <input type="text" class="required number" name="cardcvv" size="10" value=""
         title="<?php echo JText::_('J2STORE_SAGEPAY3_VALIDATION_ENTER_CARD_CVV'); ?>"
         />
         <div class="j2error"></div>
        </td>
    </tr>
